...
<script type="text/javascript">
	JotForm.init(function(){
      ...
      JotForm.totalCounter({"input_3_1001":{"price":"2.70","quantityField":"input_3_quantity_1001_0"}});
   ...
   JotForm.prepareCalculationsOnTheFly([null,{"name":"enterPayment","qid":"1","text":"Enter Payment Information","type":"control_head"},{"name":"submit","qid":"2","text":"Submit","type":"control_button"},{"description":"","name":"parkingRate","qid":"3","text":"parking rate","type":"control_paypalpro"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,{"name":"enterPayment","qid":"1","text":"Enter Payment Information","type":"control_head"},{"name":"submit","qid":"2","text":"Submit","type":"control_button"},{"description":"","name":"parkingRate","qid":"3","text":"parking rate","type":"control_paypalpro"}]);}, 20); 
</script>
	...
	<div id="content_sec">
		...
		<form class="jotform-form" action="https://pci.jotform.com/submit/201355809508356" method="post" name="form_201355809508356" id="201355809508356" accept-charset="utf-8" autocomplete="on">
  <input type="hidden" name="formID" value="201355809508356" />
  ...
  <div role="main" class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_paypalpro" id="id_3" data-payment="true">
              ...
              <div data-wrapper-react="true">
                <span class="form-product-item hover-product-item">
                  <div data-wrapper-react="true" class="form-product-item-detail">
                    <input type="checkbox" class="form-checkbox validate[required] " id="input_3_1001" name="q3_parkingRate[][id]" value="1001" />
                    ...
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <label class="form-sub-label" for="input_3_quantity_1001_0" style="min-height:13px" aria-hidden="false"> Total hour </label>
                      <select class="form-dropdown validate[required]" name="q3_parkingRate[special_1001][item_0]" id="input_3_quantity_1001_0">
              ...
              <tbody>
                ...
                <tr>
                  <td valign="top" style="min-width:50px;vertical-align:top" rowspan="2">
                    <input type="radio" class="paymentTypeRadios" id="input_3_paymentType_credit" name="q3_parkingRate[paymentType]" value="credit" />
                  ...
                  <td align="left" valign="top" style="padding-bottom:2px !important;text-align:left;vertical-align:top">
                    <input type="radio" class="paymentTypeRadios" id="input_3_paymentType_express" name="q3_parkingRate[paymentType]" checked="" value="express" />
            ...
            <table style="display:none;border:0" id="creditCardTable" class="form-address-table payment-form-table" cellPadding="0" cellSpacing="0">
              <tbody>
                ...
                <tr>
                  <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="text" id="input_3_cc_firstName" name="q3_parkingRate[cc_firstName]" class="form-textbox validate[required] cc_firstName" size="20" value="" data-component="cc_firstName" />
                  ...
                  <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="text" id="input_3_cc_lastName" name="q3_parkingRate[cc_lastName]" class="form-textbox validate[required] cc_lastName" size="20" value="" data-component="cc_lastName" />
                ...
                <tr>
                  <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="number" id="input_3_cc_number" name="q3_parkingRate[cc_number]" class="form-textbox validate[required] cc_number" autoComplete="off" size="20" value="" data-component="cc_number" />
                  ...
                  <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="number" id="input_3_cc_ccv" name="q3_parkingRate[cc_ccv]" class="form-textbox validate[required] cc_ccv" autoComplete="off" style="width:52px" value="" data-component="cc_ccv" />
                ...
                <tr>
                  <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <select class="form-dropdown validate[required] cc_exp_month" name="q3_parkingRate[cc_exp_month]" id="input_3_cc_exp_month" data-component="cc_exp_month">
                        <option>  </option>
                  ...
                  <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <select class="form-dropdown validate[required] cc_exp_year" name="q3_parkingRate[cc_exp_year]" id="input_3_cc_exp_year" data-component="cc_exp_year">
                        <option>  </option>
      ...
      <li class="form-line" data-type="control_button" id="id_2">
        <div id="cid_2" class="form-input-wide">
          <div style="margin-left:156px" data-align="auto" class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField">
            <button id="input_2" type="submit" class="form-submit-button form-submit-button-simple_carolina_blue submit-button jf-form-buttons jsTest-submitField" data-component="button" data-content="">
              Submit
            </button>
          </div>
        </div>
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="201355809508356" />
  <script type="text/javascript">
